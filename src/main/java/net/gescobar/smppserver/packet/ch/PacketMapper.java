...
/**
 * Maps packets from the cloudhopper representation to our representation and
 * vice versa.
 * 
...
public class PacketMapper {
	...
	public static SmppPacket map(Pdu pdu) {
		...
		System.out.println("Optional Parameters Count " + pdu.getOptionalParameterCount());
	...
	private static Address map(com.cloudhopper.smpp.type.Address chAddress) {
		...
		return new Address().withTon(chAddress.getTon()).withNpi(chAddress.getNpi())
